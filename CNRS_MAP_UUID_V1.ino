...
const char* version = "V1.3 - HUD + DeepSleep";
...
void loop() {
  ...
  if (millis() - lastInteractionTime > 60000 || digitalRead(BUTTON_4_PIN) == LOW) {
    sleepStatus = true;
  ...
  void Menu() {
    ...
    display.drawXBitmap(359, 252, (const uint8_t*)power_bits, power_width, power_height, GxEPD_BLACK);
  }